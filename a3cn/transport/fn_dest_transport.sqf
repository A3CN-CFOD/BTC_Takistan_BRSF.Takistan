...
a3cn_dest_transport = _air1 addAction ["<t size='1.5' shadow='2' color='#00FF00'>Helicopter Destination</t> <img size='3' color='#00ff00'", "call a3cn_fnc_dest_transport", [mappos,_air1,_flyheight,_escortgrp,player], 5, false, true, "","alive _target"];
[_pos,_air1,_flyheight,_escortgrp,name _pname] remoteExec ["a3cn_fnc_dest_transport",2];
*/
_pos = _this select 0;
