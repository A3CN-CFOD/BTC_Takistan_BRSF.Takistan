/*
V1.4 By: Ghost
Creates a marker that stays with a vehicle until its dead. a3cn_tracker = [veh, "color", "type", "name", always show marker true/false,global(true) default false] spawn a3cn_fnc_tracker.sqf";
*/
...
_markname = "a3cn_mark" + _veh_name + str (random 999);
_markertext = "";

if _global then {

	_mark1 = [_vehpos,_mcolor,_markname,_mtext,_mtype] call a3cn_fnc_mark_global;
	...
	_mark1 = [_vehpos,_mcolor,_markname,_mtext,_mtype] call a3cn_fnc_mark_local;
