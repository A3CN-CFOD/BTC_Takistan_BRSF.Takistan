...
switch (_this select 0) do
{
	case 0 :
	{
		_description = ["Derrote o Taliban e Limpe o Territorio","Derrote O Taliban","Derrote O Taliban"];
		_type = "kill";
	};
	case 1 :
	{
		_description = ["Destrua todos os Esconderijos Do Taliban","Destrua todos os Esconderijos","Destrua todos os Esconderijos"];
		_type = "destroy";
	};
	case 2 :
	{
