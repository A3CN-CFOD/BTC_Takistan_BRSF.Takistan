...
if ((isClass(configFile >> "CfgPatches" >> "rhs_main")) and (_PARAM_RHS == 1)) then {
	...
	case 0: {
		...
		ghst_aa_list = ghst_rhsaaList + ["rhs_p37"];//"rhs_prv13",
...
//Default Game units with option mods
	...
	case 0: {
		...
		ghst_convoyvehlist = ghst_carList;
		...
		ghst_aa_list = ghst_aaList;//["O_APC_Tracked_02_AA_F"];
	...
	case 1: {
		...
		ghst_aa_list = ghst_taaList;//["O_T_APC_Tracked_02_AA_ghex_F"];
