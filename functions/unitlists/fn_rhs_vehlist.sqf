...
for "_i" from 0 to (count _cfgvehicles)-1 do {
	...
	if (isClass _vehicle) then {
		...
		if ((_wvehclass == "rhs_vehclass_car") && (_wfaction == "rhs_faction_vdv") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
		...
		if ((_wvehclass == "rhs_vehclass_truck") && !(_wCName iskindof "RHS_Ural_MSV_Base") && (_wfaction == "rhs_faction_vdv") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
		...
		if (((_wvehclass == "rhs_vehclass_truck") or (_wvehclass == "rhs_vehclass_truck") or (_wCName iskindof "Car_F")) && !(_wCName iskindof "Kart_01_Base_F") && (_wfaction == "CIV_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
