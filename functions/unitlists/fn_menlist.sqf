...
for "_i" from 0 to (count _cfgvehicles)-1 do {
	...
	if (isClass _vehicle) then {
		...
		if ((_wCName iskindof "Man") && (_wvehclass == "Men") && !(_wCName iskindof "O_Soldier_unarmed_F") && !(_wCName iskindof "O_Survivor_F") && (_wfaction == "OPF_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
			...
			if (!(_wCName in _namelist) && !(_wCName iskindof "O_crew_F") && !(_wCName iskindof "O_Pilot_F") && !(_wCName iskindof "O_V_Soldier_base_F")) then {
		...
		if ((_wCName iskindof "Man") && (_wvehclass == "Men") && !(_wCName iskindof "O_T_Soldier_unarmed_F") && (_wfaction == "OPF_T_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
			...
			if (!(_wCName in _namelist) && !(_wCName iskindof "O_T_Crew_F") && !(_wCName iskindof "O_T_Pilot_F") && !(_wCName iskindof "O_V_Soldier_base_F")) then {
		...
		if ((_wCName iskindof "Man") && (_wvehclass == "Men") && !(_wCName iskindof "I_Soldier_unarmed_F") && !(_wCName iskindof "I_Survivor_F") && (_wfaction == "IND_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
			...
			if (!(_wCName in _namelist) && !(_wCName iskindof "I_crew_F") && !(_wCName iskindof "I_Pilot_F")) then {
		...
		if ((_wCName iskindof "O_Soldier_recon_base") && (_wvehclass == "MenRecon") && (_wfaction == "OPF_T_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
		...
		if ((_wCName iskindof "O_Soldier_diver_base_F") && (_wvehclass == "MenDiver") && (_wfaction == "OPF_T_F") && (_wDName!="") && (_wModel!="") && (_wscope==2)) then {
