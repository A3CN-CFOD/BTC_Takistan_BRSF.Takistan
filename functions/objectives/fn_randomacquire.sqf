...
private ["_position_mark","_radarray","_obj","_dropoff_point","_locselname","_markunitsarray","_markunits","_mcolor","_msize","_sideguards","_rnum","_tsk","_menlist","_staticlist","_vehlist","_vehsel","_crew","_spawnpos","_temppos","_md","_veh","_veh_name","_VarName","_vehpos","_pos","_mark1","_eGrp","_armor1","_g","_tasktopic","_taskdesc","_trig1stat","_trig1act","_trg1","_mass"];
