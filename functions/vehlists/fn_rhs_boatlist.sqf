...
for "_i" from 0 to (count _cfgvehicles)-1 do {
	...
	if (isClass _vehicle) then {
		...
		if ((((_wCName iskindof "Ship_F") or (_wCName iskindof "Boat_F")) && ((_wside == 1) or (_wside == 2)) && (_wscope == 2) && ((_wfaction == "BLU_F") or (_wfaction == "rhs_faction_socom")) && (_wDName!="") && (_wModel!="") && (_wpic!="")) or (_wCName iskindof "C_Scooter_Transport_01_F")) then {
			/*
