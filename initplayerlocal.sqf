...
_action = ["callTransport", "Chamar transporte", "", {["B_Heli_Transport_01_F",["RHS_AH64D"],[7774.41,1628.2,0],50,0] spawn a3cn_fnc_init_transport}, {true}] call ace_interact_menu_fnc_createAction;
